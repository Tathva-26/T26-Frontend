 ...
 */
export function PersonImage({ src, alt = "Backend Member", className = "" }) {
  return (
    <div
...
/**
 * Default Backends Data (5 Members)
 */
...
/**
 * Main Backend Page Component
 */
export default function Backend({ backends = defaultBackends }) {
  return (
    <div className="relative h-screen h-[100dvh] w-full bg-[#010208] overflow-x-hidden overflow-y-auto overscroll-contain flex flex-col font-sans select-none [-webkit-overflow-scrolling:touch]">
      ...
      {/* =====================================================
          MAIN SECTION: BACKEND TITLE (always visible) + CARDS
      ===================================================== */}
      <main className="relative z-10 w-full min-h-screen flex flex-col items-center justify-start sm:justify-center px-3 sm:px-5 md:px-8 lg:px-10 pt-20 pb-10 sm:py-6 max-w-[1920px] mx-auto">
        ...
        {/* "BACKEND" title — crisp rendered text, always sharp at any size */}
        ...
        {/* 5 Backend Cards — negative top margin on larger screens so they overlap BACKEND */}
